## Task
Here onwards, we will move to CIFAR10 since the complexity of MNIST is not enough to observe the performance of various experiments. We will focus on:
- Achieving accuracy >80%
- Making the final Receptive Field >44
- Playing with Dilated Convolutions and Depthwise Seperable Convolutions.
- Making use of Global Average Pooling and a FC layer after that to increase caqpacity.
